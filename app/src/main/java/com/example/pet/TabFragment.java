...
public class TabFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switch (tabIndex) {
            case 0:
                view = inflater.inflate(R.layout.camera_slider, container, false);
                break;
            case 2:
                view = inflater.inflate(R.layout.user_slider, container, false);
                break;
            default:
                view = inflater.inflate(R.layout.home_slider, container, false);
                break;
        }
        return view;
    }
